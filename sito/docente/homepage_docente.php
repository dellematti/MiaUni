                        ...
                        <div class="row top-buffer right-buffer" id="">
                            <div class="col-4  bottom-buffer" id="">
                                <div class="card cardSelezionabile bg p-3 h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">Gestione appelli insegnamenti</h5>
                                        <img class="card-img bg top-buffer-s" src="https://www.odg.it/wp-content/uploads/2022/02/aula-esame.jpg" alt="Card image cap">
                                        <a id="gestioneUtenti" class="stretched-link" title="Sezione gestione utenti"
                                            href="gestioneAppelli.php" >
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-4  bottom-buffer" id="">
                                <div class="card cardSelezionabile bg p-3 h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">Registrazione voti</h5>
                                        <img class="card-img bg" src="https://cdn4.vectorstock.com/i/1000x1000/43/48/good-exam-results-paper-sheet-with-pen-vector-18394348.jpg" alt="Card image cap">
                                        <a id="gestioneCdl" class="stretched-link" title="Sezione gestione CDL"
                                            href="gestioneEsiti.php" >
                                        </a>
                                    </div>
                                </div>
                            </div>
